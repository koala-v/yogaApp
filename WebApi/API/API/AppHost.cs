...
namespace WebApi
{
    public class AppHost : AppHostBase
    {
        ...
        public override void Configure(Container container)
        {
            ...
            //DB
												var dbConnectionFactory = new OrmLiteConnectionFactory(GetConnectionString("Yoga"), SqlServerDialect.Provider)
                                                {
                                                    ConnectionFilter =
                    x =>
            ...
            dbConnectionFactory.RegisterConnection("Yoga", GetConnectionString("Yoga"), SqlServerDialect.Provider);
            ...
            //Yoga
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.Sayg__Logic>();
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.Smar__Logic>();

            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.Yoga_Login_Logic>();       
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.UploadImg_Logic>();
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.DownLoadImg_Logic>();
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.Rcbp_Logic>();
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.Tobk_Logic>();
            container.RegisterAutoWired<WebApi.ServiceModel.Yoga.tjms_logic>();
        }
        #region DES
        ...
        private static string GetConnectionString(string type)
        {
            ...
            {
																if (string.Equals(type, "Yoga"))
																{
																				strAppSetting = System.Configuration.ConfigurationManager.AppSettings["Yoga_DB"];
																}
